...
const TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        query: { type: "string", description: "Search query in Swedish (e.g., 'samtycke cookies', 'Google')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific IMY decision by reference number (e.g., 'DI-2020-11332').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "IMY decision reference" },
      },
      required: ["reference"],
    },
  },
  {
    ...
    description:
      "Search IMY guidance documents: vägledningar, riktlinjer, and ställningstaganden.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query in Swedish" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description: "Get a specific IMY guidance document by its database ID.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "List all covered data protection topics with Swedish and English names.",
      ...
      switch (name) {
        ...
        case "se_dp_about": {
          return textContent({
            name: SERVER_NAME,
            version: pkgVersion,
            description: "IMY (Integritetsskyddsmyndigheten) MCP server. Provides access to Swedish data protection authority decisions, sanctions, tillsynsbeslut, and official guidance documents.",
